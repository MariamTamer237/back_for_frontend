...
class NotEnoughModuleFeaturePermissionsError(HTTPException):
    def __init__(self, module: Module, feature, persmission: Persmission) -> None:
        super().__init__(
            status_code=status.HTTP_403_FORBIDDEN,
            detail={
                "msg": f"Not enough permissions for module {module.name} feature {feature.name} and permission {persmission.name}."
            },
        )